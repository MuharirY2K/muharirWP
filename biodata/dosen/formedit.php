                        ...
                        <form action="proses_edit.php" method="POST" enctype="multipart/form-data">
                           ...
                           <div class="mb-3">
                                ...
                                <select class="form-control" name="rumpun" id="">
                                    ...
                                    <option <?php echo $data['rumpun']=='Akuntansi' ? 'selected' : '' ?> value="Akuntansi">Akutansi</option>
                                    <option <?php echo $data['rumpun']=='Manajemen' ? 'selected' : '' ?> value="Manajemen">Manajemen</option>
